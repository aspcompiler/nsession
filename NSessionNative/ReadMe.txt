========================================================================
    ACTIVE TEMPLATE LIBRARY : NSessionNative Project Overview
========================================================================

AppWizard has created this NSessionNative project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

NSessionNative.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

NSessionNative.vcxproj.filters
...
NSessionNative.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (NSessionNative.h)
        GUID definitions                                (NSessionNative_i.c)
        A type library                                  (NSessionNative.tlb)
        Marshaling code                                 (NSessionNative_p.c and dlldata.c)

NSessionNative.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in NSessionNative.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named NSessionNative.pch and a precompiled types file named StdAfx.obj.
...
NSessionNativeps.vcxproj
	...
	dlldata.c, NSessionNative_i.c and NSessionNative_p.c which are required
	to build the proxy/stub DLL.

NSessionNativeps.vcxproj.filters
